...
#pragma warning disable CS0618 // 'TextureImporter.lightmap' is obsolete: 'lightmap Property deprecated. Check [[TextureImporterSettings.textureType]] instead. Getter will work as expected. Setter will set textureType to Lightmap if true, nothing otherwise.'
            textureImporter.lightmap = false;
#pragma warning restore CS0618 // 'TextureImporter.lightmap' is obsolete: 'lightmap Property deprecated. Check [[TextureImporterSettings.textureType]] instead. Getter will work as expected. Setter will set textureType to Lightmap if true, nothing otherwise.'
            textureImporter.alphaIsTransparency = true;
#pragma warning disable CS0618 // 'TextureImporter.grayscaleToAlpha' is obsolete: 'Use UnityEditor.TextureImporter.alphaSource instead.'
            textureImporter.grayscaleToAlpha = false;
#pragma warning restore CS0618 // 'TextureImporter.grayscaleToAlpha' is obsolete: 'Use UnityEditor.TextureImporter.alphaSource instead.'
#pragma warning disable CS0618 // 'TextureImporter.linearTexture' is obsolete: 'linearTexture Property deprecated. Use sRGBTexture instead.'
            textureImporter.linearTexture = false;
#pragma warning restore CS0618 // 'TextureImporter.linearTexture' is obsolete: 'linearTexture Property deprecated. Use sRGBTexture instead.'
            textureImporter.spriteImportMode = SpriteImportMode.None;
            textureImporter.mipmapEnabled = false;
#pragma warning disable CS0618 // 'TextureImporterGenerateCubemap.None' is obsolete: 'This value is deprecated (use TextureImporter.textureShape instead).'
            textureImporter.generateCubemap = TextureImporterGenerateCubemap.None;
#pragma warning restore CS0618 // 'TextureImporterGenerateCubemap.None' is obsolete: 'This value is deprecated (use TextureImporter.textureShape instead).'
            textureImporter.filterMode = FilterMode.Point;
            textureImporter.wrapMode = TextureWrapMode.Clamp;
#pragma warning disable CS0618 // 'TextureImporterFormat.AutomaticTruecolor' is obsolete: 'Use textureCompression property instead'
#pragma warning disable CS0618 // 'TextureImporter.textureFormat' is obsolete: 'textureFormat is not longer accessible at the TextureImporter level. For old 'simple' formats use the textureCompression property for the equivalent automatic choice (Uncompressed for TrueColor, Compressed and HQCommpressed for 16 bits). For platform specific formats use the [[PlatformTextureSettings]] API. Using this setter will setup various parameters to match the new automatic system as well possible. Getter will return the last value set.'
            textureImporter.textureFormat = TextureImporterFormat.AutomaticTruecolor;
#pragma warning restore CS0618 // 'TextureImporter.textureFormat' is obsolete: 'textureFormat is not longer accessible at the TextureImporter level. For old 'simple' formats use the textureCompression property for the equivalent automatic choice (Uncompressed for TrueColor, Compressed and HQCommpressed for 16 bits). For platform specific formats use the [[PlatformTextureSettings]] API. Using this setter will setup various parameters to match the new automatic system as well possible. Getter will return the last value set.'
#pragma warning restore CS0618 // 'TextureImporterFormat.AutomaticTruecolor' is obsolete: 'Use textureCompression property instead'
        }
